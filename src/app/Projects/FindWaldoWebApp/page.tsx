    ...
    <div className="flex flex-col items-center justify-center mt-10">
      ...
      <div className="text-left w-full max-w-4xl px-4 pt-10 space-y-4">
        ...
        <p>
          ...
          made just for kids. Remember those "Where’s Waldo?" books? I turned
          that idea into a fun game you can play on a computer or tablet. It’s
          all about having a good time while getting better at noticing small
          details.
        </p>
